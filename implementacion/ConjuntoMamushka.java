...
Ejercicio02
ConjuntoMamushkaTDA
Similar a ConjuntoTDA, pero permite múltiples “acepciones” (repeticiones) 
de un mismo elemento y ofrece un método perteneceCant(dato) que devuelve 
cuántas veces está presente.
 */

/*
Estrategia:
Se usa un DiccionarioSimpleTDA para almacenar la cantidad de veces que 
se agregó cada valor. La clave es el valor y el contenido es la cantidad 
de repeticiones. Los métodos ajustan ese contador según corresponda.
*/
